...
public class Market {
  ...
  public void addCartWithItem(String itemName, double itemPrice) {
    Cart baru = new Cart();
    baru.addItem(itemName, itemPrice);
    this.carts.add(baru);
  }
  ...
  public void checkoutAllCarts() {
    ...
    for (Cart a: this.carts){
        double harga = a.checkout();
        System.out.printf("Total amount for cart %d: Rp %.0f%n", a.getCartId(), harga);
        total += harga;
    }
