public abstract class Chatbot {
    ...
    public final String reply(UserMessage message) {
        ...
        if (message == null){
            ...
            message = new UserMessage(message.getContent(), MessageType.UNKNOWN);
        }
        ...
        ResponseStyle gaya = this.responseStyle;
        String formattedResponse = gaya.format(baseResponse);
    ...
    protected String craftResponse(MessageType type, UserMessage message) {
        ...
        else if (type == MessageType.GREETING){
