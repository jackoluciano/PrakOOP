...
final class ChampionDuel<T extends Comparable<T>>{
    ...
    String report() {
        ...
        // "<label> champion between <player pertama> and <player kedua> is: <hasil decide champion>"
        return label +" champion between "+first.toString()+" and "+second.toString()+" is: "+ decideChampion();
    }
}
