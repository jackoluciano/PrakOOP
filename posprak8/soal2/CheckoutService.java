...
public class CheckoutService {
   ...
   * 2. Cari produk via find(productId) (memungkinkan lempar Exception pada method find) 
   * -> cara memanggil find(productId) bisa dengan this.find(productId) lalu masukkan ke variabel Product p
