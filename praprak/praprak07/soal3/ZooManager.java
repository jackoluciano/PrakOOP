...
public class ZooManager {
    ...
    // TODO: Lengkapi tipe wildcard pada parameter
    public static void addMammals(List<? super Animal> list, Mammal mammal) {
    ...
    public static void transferAnimal(Enclosure<? extends Animal> source, Enclosure<? super Animal> destination) {
        ...
        System.out.println(source.getAnimal().getName()+" dipindahkan dari kandang "+source.getEnclosureId()+" ke "+destination.getEnclosureId());
