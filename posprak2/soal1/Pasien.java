public class Pasien {
    ...
    public Pasien(DataPribadi dataPribadi, String keluhan, String tingkatUrgent) {
        ...
        nomorPasien = String.format("%04d", nomorUrut);
    ...
    public boolean assignDokter(Dokter dokter) {
        ...
        if (tingkatUrgent == "Berat" && dokter.getSpesialisasi() == "Umum"){
            return false;
        } if (tingkatUrgent == "Sedang" && dokter.getSpesialisasi() == "Umum"){
            return false;
        }
        ...
        if (tingkatUrgent == "Ringan"){
            multiplier = 1;
        } else if (tingkatUrgent == "Sedang"){
            multiplier = 1.5;
        } else if (tingkatUrgent == "Berat"){
            multiplier = 2;
        }
    ...
    public String toString() {
        String format = String.format("%,.0f", biaya);
        return ""+nomorPasien+" - "+dataPribadi.getNama()+" ("+tingkatUrgent+") - Biaya: Rp"+format+"";
    }
